...
| --- | --- | --- | --- |
| Kujo SSG | 1.0.0 + Experimental WebMCP v1 (`e750232`) | `build.kujo`, search and validation scripts | <https://github.com/kujolang/ssg/commit/e750232> |
...
All other SSG behavior remains based on 1.0.0.
